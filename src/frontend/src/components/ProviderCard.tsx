...
const serviceBadges: Record<string, { label: string; tooltip: string; link: string }> = {
  ...
  'financial-planning': { label: 'Financial Planning', tooltip: 'Special needs financial planning and benefits preservation', link: '/resources/services/financial-planning' },
...
const insuranceBadges: Record<string, { label: string; tooltip: string; link: string }> = {
  ...
  'molina': { label: 'Molina', tooltip: 'Molina Healthcare plans', link: '/resources/insurances/molina' },
  'molina-healthcare': { label: 'Molina', tooltip: 'Molina Healthcare plans', link: '/resources/insurances/molina' },
  'molinahealthcare': { label: 'Molina', tooltip: 'Molina Healthcare plans', link: '/resources/insurances/molina' },
