...
const ServiceBadges = () => (
  <div className="flex flex-wrap gap-1.5">
    <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800 border border-blue-200">Skilled Nursing</span>
    ...
    <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800 border border-blue-200">Occupational Therapy</span>
  </div>
);
...
const InsuranceBadges = () => (
  <div>
    ...
    <div className="flex flex-wrap gap-1.5">
      ...
      <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-purple-100 text-purple-800 border border-purple-200">Sunshine Health</span>
      <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-purple-100 text-purple-800 border border-purple-200">Humana</span>
    </div>
  </div>
);
...
const WhyChooseUs = () => (
  <div className="bg-teal-50 border border-teal-200 rounded-lg p-4 mb-4">
    ...
    <ul className="text-sm text-teal-700 space-y-1.5">
      <li className="flex items-start gap-2"><span className="text-teal-500 mt-0.5">&bull;</span> Licensed nurses on-site at all times with 10+ years of pediatric experience</li>
      <li className="flex items-start gap-2"><span className="text-teal-500 mt-0.5">&bull;</span> On-site PT, OT, and speech therapy integrated into daily schedule</li>
      <li className="flex items-start gap-2"><span className="text-teal-500 mt-0.5">&bull;</span> Free door-to-door transportation included for all enrolled families</li>
    </ul>
  </div>
);
        ...
        <div className="flex flex-col gap-3">
          <div className="flex flex-wrap items-start justify-between gap-2">
            <div className="flex-1 min-w-0">
              <h4 className="text-lg font-semibold text-gray-900 leading-tight">Sunshine Kids Childcare & PPEC</h4>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm">
            ...
            <div className="flex items-start text-gray-600 sm:col-span-2">{mapPinSvg}<span>1234 Care Center Drive, Orlando, FL 32801</span></div>
          </div>
      ...
      <div className="p-5">
        <div className="flex flex-col gap-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm">
            ...
            <div className="flex items-start text-gray-600 sm:col-span-2">{mapPinSvg}1234 Care Center Drive, Orlando, FL 32801</div>
          </div>
          <div className="flex justify-end pt-3 mt-3 border-t border-gray-100">
            <span className="inline-flex items-center px-4 py-2 text-sm font-medium rounded-md border border-teal-600 text-teal-600">View Details</span>
          </div>
      ...
      <div className="p-5">
        <div className="flex flex-col gap-3">
          <div className="w-full h-36 rounded-lg bg-gray-100 border-2 border-dashed border-gray-300 flex flex-col items-center justify-center">
            ...
            <span className="text-sm font-semibold text-gray-400">Your Facility Photo</span>
          </div>
          <div className="flex flex-wrap items-start justify-between gap-2">
            <div className="flex-1 min-w-0">
              <h4 className="text-lg font-semibold text-gray-900 leading-tight">Sunshine Kids Childcare & PPEC</h4>
          ...
          <p className="text-sm text-gray-600 leading-relaxed line-clamp-3">Sunshine Kids Childcare & PPEC provides compassionate, licensed care for children with special needs including skilled nursing, therapy services, and developmental programming.</p>
          <ServiceBadges />
          <InsuranceBadges />
          <div className="grid grid-cols-1 gap-2 text-sm">
            <div className="flex items-center text-gray-600">{phoneSvg}(407) 555-0142</div>
            <div className="flex items-start text-gray-600">{mapPinSvg}1234 Care Center Drive, Orlando, FL 32801</div>
          </div>
          <SocialIcons />
    ...
    <div className="rounded-lg shadow-lg hover:shadow-xl transition-shadow overflow-hidden h-full" style={{ border: "3px solid transparent", backgroundImage: "linear-gradient(to bottom, #fffbeb, #ffffff 40%, #fffbeb), linear-gradient(135deg, #f59e0b, #d97706, #b45309, #d97706, #f59e0b)", backgroundOrigin: "border-box", backgroundClip: "padding-box, border-box" }}>
      ...
      <div className="p-6">
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-wrap items-start justify-between gap-2">
            <div className="flex-1 min-w-0">
              <h4 className="text-xl font-bold text-gray-900 leading-tight">Sunshine Kids Childcare & PPEC</h4>
              <p className="text-sm text-gray-500 mt-0.5">Orange County</p>
              <div className="mt-1 flex items-center gap-1.5">
                <img src="https://www.google.com/favicon.ico" alt="Google" className="w-4 h-4" />
                <Stars />
          ...
          <p className="text-sm text-gray-600 leading-relaxed">Sunshine Kids Childcare & PPEC provides compassionate, licensed care for children with special needs including skilled nursing, therapy services, and developmental programming. Our licensed nurses and therapists create individualized care plans for every child.</p>
          <ServiceBadges />
          <InsuranceBadges />
          <div className="grid grid-cols-1 gap-2 text-sm">
            <div className="flex items-center text-gray-600">{phoneSvg}(407) 555-0142</div>
            <div className="flex items-start text-gray-600">{mapPinSvg}1234 Care Center Drive, Orlando, FL 32801</div>
            <div className="flex items-center text-gray-600">{emailSvg}info@sunshinekidsppec.com</div>
          </div>
          <SocialIcons />
          <a href="#" className="inline-flex items-center justify-center w-full px-4 py-2.5 text-sm font-semibold rounded-md bg-teal-600 text-white hover:bg-teal-700 transition-colors">
            <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9"></path></svg>
  ...
  return (
    <div className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow overflow-hidden h-full">
      <div className="bg-gradient-to-r from-teal-600 to-cyan-600 text-white px-6 py-5">
        <h4 className="text-xl font-bold">Sunshine Kids Childcare & PPEC</h4>
        <p className="text-teal-100 text-sm mt-1">1234 Care Center Drive, Orlando, FL 32801 &bull; Orange County</p>
      </div>
      <div className="p-6">
        ...
        <p className="text-sm text-gray-600 mb-4">Sunshine Kids Childcare & PPEC provides compassionate, licensed care for children with special needs including skilled nursing, therapy services, and developmental programming.</p>
        <ServiceBadges />
    ...
    <div className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow overflow-hidden h-full" style={{ border: "2px solid #d97706" }}>
      <div className="relative">
        <div className="w-full h-48 bg-gray-100 border-b-2 border-dashed border-gray-300 flex flex-col items-center justify-center">
          {cameraSvg("w-12 h-12 text-gray-400 mb-2")}
          <span className="text-base font-semibold text-gray-400">Your Facility Photo or Logo</span>
      ...
      <div className="p-6">
        <h4 className="text-xl font-bold text-gray-900 mb-1">Sunshine Kids Childcare & PPEC</h4>
        <p className="text-sm text-gray-500 mb-3">1234 Care Center Drive, Orlando, FL 32801 &bull; Orange County</p>
        <div className="flex items-center gap-2 mb-4">
          <VerifiedBadge />
          <div className="flex items-center gap-1">
            <img src="https://www.google.com/favicon.ico" alt="Google" className="w-4 h-4" />
        ...
        <p className="text-sm text-gray-600 mb-4">Sunshine Kids Childcare & PPEC provides compassionate, licensed care for children with special needs including skilled nursing, therapy services, and developmental programming. Our licensed nurses and therapists create individualized care plans.</p>
        <WhyChooseUs />
        <ServiceBadges />
        <div className="mt-3"><InsuranceBadges /></div>
  ...
  return (
    <div className="rounded-lg shadow-lg hover:shadow-xl transition-shadow overflow-hidden h-full" style={{ border: "3px solid transparent", backgroundImage: "linear-gradient(white, white), linear-gradient(135deg, #f59e0b, #d97706, #b45309, #d97706, #f59e0b)", backgroundOrigin: "border-box", backgroundClip: "padding-box, border-box" }}>
      ...
      <div className="p-6" style={{ background: "linear-gradient(135deg, #fffbeb 0%, #ffffff 40%, #fffbeb 100%)" }}>
        <h4 className="text-2xl font-bold text-gray-900 mb-1">Sunshine Kids Childcare & PPEC</h4>
        <p className="text-sm text-gray-500 mb-3">1234 Care Center Drive, Orlando, FL 32801 &bull; Orange County</p>
        <div className="flex items-center gap-2 mb-4">
          <VerifiedBadge />
          <div className="flex items-center gap-1">
        ...
        <p className="text-sm text-gray-600 mb-4">Sunshine Kids Childcare & PPEC provides compassionate, licensed care for children with special needs including skilled nursing, therapy services, and developmental programming. Our licensed nurses and therapists create individualized care plans for every child.</p>
        <WhyChooseUs />
        <ServiceBadges />
        <div className="mt-3"><InsuranceBadges /></div>
        <div className="flex flex-wrap gap-x-4 gap-y-2 text-sm border-t border-gray-100 pt-4 mt-4 mb-4">
...
const faqItems = [
  {
    ...
    a: "When families search for daycares, preschools, or PPEC centers on FloridaAutismServices.com, Featured listings appear above standard results. Premium Partners are pinned to the very top, followed by Enhanced, then Basic. Within each tier, listings are ordered by relevance to the search.",
  },
  {
    q: "What do I need to provide?",
    a: "For Basic, nothing extra — we enhance your existing listing. For Enhanced and Premium, we'll ask for a facility photo or logo and a short 'Why Choose Us' description (2-3 sentences). We handle the rest.",
  },
  {
  ...
  },
  {
    ...
    a: "Google Ads charges you per click and competes with every childcare provider in your area. Featured Listings give you persistent, always-on visibility specifically to parents searching for special needs childcare in Florida — for a flat monthly rate.",
  },
  {
      ...
      <section className="bg-gradient-to-r from-teal-600 to-cyan-600 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight mb-6">
            Get Found First by Florida Families Searching for Childcare
          </h1>
          <p className="text-lg sm:text-xl text-teal-50 max-w-3xl mx-auto mb-10">
            Featured listings put your daycare, preschool, or PPEC center at the top of search results on Florida's largest autism resource directory — so the families who need you can actually find you.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-0 mb-10">
            <div className="px-6 sm:border-r sm:border-white/30">
              ...
              <p className="text-teal-100 text-sm">Childcare Facilities Listed</p>
            </div>
            <div className="px-6 sm:border-r sm:border-white/30">
              <p className="text-2xl font-bold">80%</p>
              <p className="text-teal-100 text-sm">Parents Start Online</p>
            </div>
            <div className="px-6">
              <p className="text-2xl font-bold">100%</p>
              <p className="text-teal-100 text-sm">Special Needs Focused</p>
            </div>
          </div>
          <button
      ...
      <section className="bg-white py-20 px-4">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-8">
            You're Listed. But Are Families Finding You?
          </h2>
          <div className="text-gray-600 text-lg leading-relaxed space-y-6">
            <p>
              Right now, your facility is one of hundreds of childcare providers in our directory. When a parent in your county searches for special needs daycare or PPEC services, they see a long list of results. They click the first few. Maybe the first five. Then they pick up the phone.
            </p>
        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="bg-white rounded-xl shadow-md border border-gray-100 p-6 sm:p-8 max-w-2xl mx-auto">
            ...
            <svg viewBox="0 0 500 260" className="w-full" aria-label="Growth chart showing monthly search impressions from October 2025 to February 2026">
              ...
              <defs>
                <linearGradient id="daycaresTealGrad" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="0%" stopColor="#14b8a6" stopOpacity="0.3" />
                  <stop offset="100%" stopColor="#14b8a6" stopOpacity="0.05" />
                </linearGradient>
              </defs>
              <path d="M 162.5 219.5 L 265 216.6 L 367.5 118.8 L 470 40 L 470 220 L 162.5 220 Z" fill="url(#daycaresTealGrad)" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Your listing jumps above standard results. When families search for childcare in your county, you're at the top — not buried on page two.
              </p>
            </div>
            <div className="text-center">
              <div className="w-14 h-14 rounded-full bg-teal-100 flex items-center justify-center mx-auto mb-5">
              ...
              <p className="text-gray-600">
                Facility photos, expanded descriptions, and a "Visit Website" button make your listing impossible to scroll past.
              </p>
            </div>
            <div className="text-center">
              <div className="w-14 h-14 rounded-full bg-teal-100 flex items-center justify-center mx-auto mb-5">
              ...
              <p className="text-gray-600">
                Featured and Premium Partner badges signal to families that you're an established, trusted childcare facility.
              </p>
            </div>
          </div>
      ...
      <section className="bg-white py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 text-center mb-4">
            Where Featured Facilities Appear in Search Results
          </h2>
      ...
      <section id="search-cards" className="bg-gray-50 py-20 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-gray-500 text-lg text-center mb-12">
            Same facility. Four visibility levels. See the difference.
          </p>
      ...
      <section className="bg-white py-20 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-center text-gray-500 italic mt-10 max-w-2xl mx-auto">
            Enhanced and Premium listings include facility photos, a "Why Choose Us" section, and direct website links — everything a parent needs to choose you.
          </p>
        </div>
      </section>
          ...
          <div id="multi-location" className="mt-16 max-w-4xl mx-auto">
            <div className="bg-gradient-to-br from-teal-50 to-cyan-50 border border-teal-200 rounded-xl p-8 sm:p-10">
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-6 max-w-lg mx-auto">
                <h4 className="font-semibold text-gray-800 mb-3 text-sm uppercase tracking-wide">Example: 4 Locations at Enhanced Featured</h4>
                <div className="space-y-2 text-sm text-gray-600">
                  <div className="flex justify-between">
                    <span>Regular price</span>
                    <span className="text-gray-400 line-through">$59/location × 4 = $236/mo</span>
                  </div>
                  <div className="flex justify-between">
                    <span>With 20% volume discount</span>
                    <span className="font-medium text-gray-700">$189/mo</span>
                  </div>
                  <div className="flex justify-between border-t border-gray-100 pt-2">
                    <span className="font-semibold text-teal-700">With Founding Partner 50% off</span>
                    <span className="font-bold text-teal-700 text-base">$94/mo</span>
                  </div>
                </div>
                <p className="text-xs text-gray-400 mt-3">That's just $23.50/location/month for priority placement across 4 service areas.</p>
              </div>

              <div className="text-center mt-8">
                <a
                  href="mailto:contact@floridaautismservices.com?subject=Multi-Location%20Featured%20Daycare%20Listing%20Inquiry"
            ...
            <table className="w-full min-w-[700px] text-sm border-collapse">
              ...
              <tbody>
                {[
                  ...
                  { feature: "Facility photos on listings", free: false, basic: false, enhanced: true, premium: true },
