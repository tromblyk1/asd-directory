...
const serviceOptions = [
  ...
  { value: 'animal-therapy', label: 'Animal Therapy', description: 'Animal-assisted therapy', tooltip: 'Therapeutic interventions with trained animals to reduce anxiety and motivate engagement' },
  ...
  { value: 'autism-travel', label: 'Autism Travel', description: 'Sensory-friendly trip planning', tooltip: 'Travel planners who arrange sensory-friendly trips, accommodations, and airport and park supports' },
...
const servicePopupInfo: Record<string, { label: string; description: string; slug: string }> = {
  ...
  'animal-therapy': { label: 'Animal', description: 'Animal-assisted therapy', slug: 'animal-therapy' },
  ...
  'autism-travel': { label: 'Travel', description: 'Autism travel planning', slug: 'autism-travel' },
